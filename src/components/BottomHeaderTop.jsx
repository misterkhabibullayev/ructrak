...
function BottomHeaderTop() {
  ...
  const [MIsOpen, setMIsOpen] = useState();
        ...
        <div className="flex items-center justify-between">
          <div className="text-black dark:text-white group flex items-center gap-1">
            ...
            <a
              ...
              className="font-FiraSans font-normal text-[15px] leading-[110%] text-black dark:text-white group-hover:text-[#FEC80B] transition-all duration-300"
            >
              {t("header.address")}
            </a>
          </div>
          <div className="flex items-center gap-10">
            ...
            >
              ...
              >
                ...
                <span className="ont-FiraSans font-normal text-[15px] leading-[110%] text-black dark:text-white">{CurrentTitle}</span>
              </button>
