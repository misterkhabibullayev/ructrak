...
import { aboutCardsData } from "../data/aboutData";
    ...
    <section className="overflow-hidden my-20">
      <div className="container1 mt-20">
        <div className="flex items-end justify-between mb-8">
          <h1 className="font-FiraSans font-medium text-[18px] md:text-[22px] w-full md:w-1/2 dark:text-white">
            {t("aboutPage.swiperTitle")}
          </h1>
