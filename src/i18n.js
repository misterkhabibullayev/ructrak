  ...
  ru: {
    translation: {
      ...
      catFilPage: {
        ...
        sortNewOnesFirst: "Сначала новые",
        sortInStock: "В наличии",
        sortByAscending: "По возрастанию цены",
        someone: "Мне нужен такой же",
  ...
  uz: {
    translation: {
      ...
      catFilPage: {
        ...
        filter: "Filtr",
        sorting: "Saralash:",
        sortBrand: "Brend bo'yicha",
        sortPopularity: "Ommabopligi bo'yicha",
        sortNewOnesFirst: "Avval yangilari",
        sortInStock: "Mavjudlari",
        sortByAscending: "Narxi o'sishi bo'yicha",
        someone: "Xuddi shundayi kerak",
        notAvailable: "Sotuvda yo'q",
        brand: "Brend",
        find: "Topish",
        showProducts: "Mahsulotlarni ko'rsatish",
        from: "dan",
        to: "gacha",
      },
      favoritesPage: {
  ...
  en: {
    translation: {
      ...
      catFilPage: {
        ...
        sortNewOnesFirst: "Newest first",
        sortInStock: "In stock",
        sortByAscending: "Price: Low to High",
        someone: "I need the same one",
